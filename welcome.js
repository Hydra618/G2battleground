...
module.exports = function (client) {
  ...
  if (welmsg) {
    ...
    for (const match of matches) {
      ...
      const background = await Canvas.loadImage(`https://cdn.glitch.global/41bc2469-17cd-4d1a-a100-1e79c61bfe14/welcome.png?v=1644940468398`);
    ...
    client.channels.cache.get(welchannl).send({ embeds: [welcomeembed], files: [attachment] })
